...
struct AboutView: View {
    ...
    private let detailsTips: [(title: String, detail: String)] = [
        ...
        ("Text fields & text boxes", "Add one with the toolbar's Add Text Field / Add Text Box buttons (also in the Edit menu, at the bottom). Double-click a text item to edit its content and formatting — typeface, size, Bold/Italic, colour, alignment, letter spacing, and line height, with a live preview as you type. A field doesn't wrap (only an explicit Return breaks a line); a box wraps to its width like a paragraph. Drag to move or resize it freely, like reshaping a box — hold ⌘ or ⌥ while resizing instead to scale the text proportionally, font size included."),
